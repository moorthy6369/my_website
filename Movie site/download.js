 ...
 num2 = Number(loca.slice(loca.lastIndexOf("s") + 1, loca.lastIndexOf("n")));
                 ...
                 function init() {
                     fetch(url)
                         ...
                         .then(rep => {
                             ...
                             let yu=[];
                             let yup; try { yup = jsonData.table.rows[num2].c[8].v;}catch{};  yup === undefined || yup === null ? "#" : yu.push(8);
                             let yup1; try { yup1 = jsonData.table.rows[num2].c[9].v;}catch{};  yup1 === undefined || yup1 === null ? "#" : yu.push(9);
                             let yup2; try { yup2 = jsonData.table.rows[num2].c[10].v;}catch{};  yup2 === undefined || yup2 === null ? "#" : yu.push(10);
                             let yup3; try { yup3 = jsonData.table.rows[num2].c[11].v;}catch{};  yup3 === undefined || yup3 === null  ? "#" : yu.push(11);
                             let x =[];
                             let typeoflink ="";
                             try { typeoflink = jsonData.table.rows[num2].c[6].v == 2 ? " GDrive":""}catch{};
                             for (let i = 0; i < yu.length; i++) {
                                 let typeoflink1 = jsonData.table.rows[num2].c[Number(yu[i])].v.slice(0,13)=="https://drive" ? typeoflink : "";
                                 ...
                                 var types="r" + num2 + "c"+Number(yu[i]);var typel="&ql=p" + num6 + "n1s";
 ...
 function show(lk) {
     ...
     window.open(lk);
     setTimeout(function () {
         docs("yt", "block"); docs("btn_yt", "none"); docs("ytv", "none");
         docs("countdown", "block"); docs("downloadbuttonmain", "block");
     }, 1000);
     docs("btn_yt", "none"); docs("ytv", "block"); docs("countdown", "block"); docs("downloadbuttonmain", "none");
     var timeleft = 8;
